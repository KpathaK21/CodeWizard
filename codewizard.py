...
def main():
    parser = argparse.ArgumentParser(description="CodeWizard – AI Debugging Assistant")
    parser.add_argument("--llm", type=str, default="openai:gpt-4o",
                        help="Choose LLM provider and model (e.g. openai:gpt-4o)")
    args = parser.parse_args()

    print("\n🧙 Welcome to CodeWizard! Paste your error message, stack trace, or buggy code below.")
    user_input = input(">>> ")
